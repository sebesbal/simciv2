...
void TileMapView::draw_rect(int x, int y, double rate, double alpha)
{
	Rect r = get_rect(x, y);
...
void TileMapView::draw_triangles(int x, int y, double a, double b)
{
	Rect r = get_rect(x, y);
	Vec2 v[3];
...
void TileMapView::draw_circles(int x, int y, double a, double b)
{
	Rect r = get_rect(x, y);
...
void TileMapView::draw_rect_green(int x, int y, double rate, double alpha)
{
	Rect r = get_rect(x, y);
